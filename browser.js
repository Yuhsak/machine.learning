...
/***/ function(module, exports, __webpack_require__) {
	...
	const Perceptron = __webpack_require__(1).default
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = {
		...
		isNested: function isNested(arr) {
			return Array.isArray(arr[0]);
		},
		runAsync: function runAsync(callback) {
			var isBrowser = new Function("try {return this===window;}catch(e){ return false;}");
			isBrowser() ? setTimeout(function () {
				callback();
	...
	var _map = [].concat((0, _toConsumableArray3.default)(Array(4).keys())).map(_symbol2.default),
	...
	var Perceptron = function () {
		...
		(0, _createClass3.default)(Perceptron, [{
			key: _startSync,
				...
				return new _promise2.default(function (resolve, reject) {
					(function _loop(_i) {
						return new _promise2.default(function (_resolve, _reject) {
							var shouldBreak = self[_process]();
							util.runAsync(function () {
								_resolve({ time: _i + 1, shouldBreak: shouldBreak });
							});
						}).then(function (_ref2) {
							var time = _ref2.time,
							    shouldBreak = _ref2.shouldBreak;
			...
			key: 'be',
			value: function be(label) {
				var _label = Array.isArray(label) ? label : [label];
				this.y = [].concat((0, _toConsumableArray3.default)(this.y), (0, _toConsumableArray3.default)(_label));
				return this;
			}
		}, {
			key: 'output',
			...
			value: function on(name, func) {
				this.events[name] = !this.events[name] ? [func] : [].concat((0, _toConsumableArray3.default)(this.events[name]), [func]);
			}
		}, {
			key: 'emit',
			value: function emit(name, arg) {
				if (this.events[name]) this.events[name].forEach(function (func) {
					func(arg);
				});
			}
		}, {
